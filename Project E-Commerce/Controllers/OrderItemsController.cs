...
namespace Project_E_Commerce.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Quantity,Price,CreatedAt,OrderId,ProductId")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Quantity,Price,CreatedAt,OrderId,ProductId")] OrderItem orderItem)
        {
            if (id != orderItem.Id)
            {
                return NotFound();
